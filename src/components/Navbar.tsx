      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            <LoginModal>
              <button className="text-gray-700 hover:text-mixvinicius-green flex items-center">
                <User className="h-5 w-5 mr-1" />
                <span>Entrar</span>
              </button>
            </LoginModal>
            <CartModal>
              <button className="flex items-center text-gray-700 hover:text-mixvinicius-green relative">
          ...
          <div className="flex items-center md:hidden">
            <CartModal>
              <button className="mr-4 text-gray-700 relative">
        ...
        <div className="md:hidden bg-white border-t border-gray-200 py-3 animate-fade-in">
          <div className="container mx-auto px-4">
            <nav className="flex flex-col space-y-3">
              <LoginModal>
                <button className="flex items-center py-2 px-3 rounded-lg hover:bg-gray-100 w-full text-left">
