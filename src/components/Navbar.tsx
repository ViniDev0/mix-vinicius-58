...
const Navbar = () => {
  ...
  return <header className="bg-white sticky top-0 z-50 shadow-sm">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center">
            <img src="/lovable-uploads/eff02627-dbd8-449f-b7ae-86b8a97f2d72.png" alt="MixVinicius Logo" className="h-16 w-auto mr-2" />
          </div>

          {/* Search Bar - Hidden on Mobile */}
          <div className="hidden md:flex items-center flex-1 max-w-md mx-4">
            <div className="relative w-full">
              <input type="text" placeholder="Buscar produtos..." className="w-full pl-4 pr-10 py-2 border border-gray-300 rounded-full focus:outline-none focus:border-mixvinicius-green" />
          ...
          <div className="flex items-center md:hidden">
            ...
            <button onClick={toggleMenu} className="text-gray-700" aria-label={isMenuOpen ? "Fechar menu" : "Abrir menu"}>
        ...
        <div className="pb-3 pt-1 md:hidden">
          <div className="relative">
            <input type="text" placeholder="Buscar produtos..." className="w-full pl-4 pr-10 py-2 border border-gray-300 rounded-full focus:outline-none focus:border-mixvinicius-green text-sm" />
      ...
      {/* Mobile Menu */}
      {isMenuOpen && <div className="md:hidden bg-white border-t border-gray-200 py-3 animate-fade-in">
          <div className="container mx-auto px-4">
